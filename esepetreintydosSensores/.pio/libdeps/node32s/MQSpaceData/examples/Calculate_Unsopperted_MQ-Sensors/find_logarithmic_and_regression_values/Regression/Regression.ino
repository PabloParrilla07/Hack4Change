...
"""
# After marking the data from the web plot digitizer program and configuring the slopes with 
# the dangerousPer() functions, you can submit a pull request (on github) for new gas sensors 
# by saving the files to the datasheet example, as in the "Regression" example.
