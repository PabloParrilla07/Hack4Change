...
public class SensorClient extends AbstractVerticle{
	...
	public void start(Promise<Void> startFuture) {
		...
		Promise<Sensors[]> resList = Promise.promise();
		...
		sensorClientUtil.getRequest(443, "https://67d2c5c590e0670699befc4a.mockapi.io", "api/v1/sensors", 
				Sensors[].class, resList);

		/* --------------- GET one request --------------- */

		Promise<Sensors> res = Promise.promise();
	...
	//			UserEntity.class, res);
		sensorClientUtil.getRequest(443, "https://67d2c5c590e0670699befc4a.mockapi.io", "api/v1/sensors/1", 
				Sensors.class, res);

		/* --------------- GET request con parámetros--------------- */

//		Promise<Sensors> resWithParams = Promise.promise();
